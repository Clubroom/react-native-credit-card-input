...
import { View, Text, StyleSheet, Image, LayoutAnimation, TouchableOpacity, TextInput } from 'react-native';
    ...
    return (
      <View style={s.container}>
        <View style={[s.leftPart, showRightPart ? s.hidden : s.expanded]}>
          <CCInput {...this._inputProps('number')} keyboardType="numeric" containerStyle={s.numberInput} />
        </View>
        ...
        <View style={[s.rightPart, showRightPart ? s.expanded : s.hidden]}>
          ...
          <CCInput
            ...
            keyboardType="numeric"
            inputStyle={[s.input, { textAlign: 'center' }]}
